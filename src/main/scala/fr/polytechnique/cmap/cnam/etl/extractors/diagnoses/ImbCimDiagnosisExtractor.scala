...
import fr.polytechnique.cmap.cnam.etl.extractors.imb.ImbBasicExtractor
import fr.polytechnique.cmap.cnam.etl.sources.Sources


final case class ImbCimDiagnosisExtractor(codes: BaseExtractorCodes) extends ImbBasicExtractor[Diagnosis]
