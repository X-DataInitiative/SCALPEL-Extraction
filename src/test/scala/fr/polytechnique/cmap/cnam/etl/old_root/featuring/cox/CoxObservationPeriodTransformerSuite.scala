package fr.polytechnique.cmap.cnam.etl.old_root.featuring.cox
...
class CoxObservationPeriodTransformerSuite extends SharedContext {
  ...
  "withObservationStart" should "add a column with the start of the observation period" in {
    ...
    // When
    import fr.polytechnique.cmap.cnam.etl.old_root.featuring.cox.CoxObservationPeriodTransformer.ObservationDataFrame
  ...
  "withObservationPeriod" should "add a column for the observation start and one for the end" in {
    ...
    // When
    import fr.polytechnique.cmap.cnam.etl.old_root.featuring.cox.CoxObservationPeriodTransformer.ObservationFunctions
