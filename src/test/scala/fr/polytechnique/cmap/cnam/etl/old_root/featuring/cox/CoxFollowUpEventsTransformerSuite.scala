...
class CoxFollowUpEventsTransformerSuite extends SharedContext {
  ...
  "withFollowUpStart" should "add a column with the start of the follow-up period" in {
    ...
    // When
    import fr.polytechnique.cmap.cnam.etl.old_root.featuring.cox.CoxFollowUpEventsTransformer.FollowUpDataFrame
  ...
  "withFollowUpPeriod" should "add a column for the follow-up start and one for the end" in {
    ...
    // When
    import fr.polytechnique.cmap.cnam.etl.old_root.featuring.cox.CoxFollowUpEventsTransformer.FollowUpFunctions
