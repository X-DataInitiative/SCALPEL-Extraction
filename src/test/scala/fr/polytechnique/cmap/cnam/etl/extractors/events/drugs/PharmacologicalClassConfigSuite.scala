...
import fr.polytechnique.cmap.cnam.etl.extractors.events.drugs.classification.PharmacologicalClassConfig
import fr.polytechnique.cmap.cnam.etl.extractors.events.drugs.classification.families.Antidepresseurs
